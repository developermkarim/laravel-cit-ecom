            ...
            <div class="col-lg-3 order-2 order-lg-1">
                ...
                <div class="sidebar-categores-box mt-sm-30 mt-xs-30">
                    ...
                    <div class="category-sub-menu">
                        <ul>
                            <li class="has-sub"><a>Categories</a>
                                <ul style="display: none;">
                                    ...
                                    <li><a href="{{ route('product.shopFilter',$category->slug) }}">{{ $category->title }}</a></li>
                                    
                                    @endforeach
                                </ul>
                            </li>
                            <li class="has-sub"><a href="#">Sub Category</a>
                                <ul style="">
                                    @foreach ($categories as $category)
                                    @foreach ($category->subCategory as $subCate)
                                        
                                    @endforeach
                                    <li><a href="{{ route('product.shopFilter',$subCate->slug) }}">{{ $subCate->title }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            <li class="has-sub"><a href="#">Brand</a>
                                <ul style="">
                                    ...
                                    <li><a href="#">{{ $brandItem->title }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="sidebar-categores-box">
                    <div class="sidebar-title">
                        <h2 class="my-0 py-0">Filter By</h2>
                    </div>
                    <!-- btn-clear-all start -->
                    <button class="btn-clear-all mb-sm-30 mb-xs-30 mb-3">Clear all</button>
                    <!-- btn-clear-all end -->

                     {{-- Filter Price range area start --}}
                     <div class="price-range-block">
                        ...
                        <form action="{{ route('product.shopFilter') }}" method="get">

                            @csrf

                        <div style="margin" class="price-input d-flex my-2">
                            <input type="text" placeholder="min price" id="min_price" name="startPrice" class="price-range-field" /> &nbsp;
                            <input type="text"  name="endPrice" placeholder="max price" class="price-range-field form-control" />
                         {{--  <input  placeholder="min price" min=0 max="9900" oninput="validity.valid||(value='0');" id="min_price" name="startPrice" class="price-range-field" /> &nbsp;
                          <input  min=0 max="10000" oninput="validity.valid||(value='10000');" id="max_price" name="endPrice" placeholder="max price" class="price-range-field form-control" /> --}}
                        </div>
                    
                        <button type="submit" class="btn price-range-search" id="price-range-submit">Search</button>
                    </form>
                        <div id="searchResults" class="search-results-block"></div>
                    
                    </div>

                    {{-- Filter Price range area end --}}
