...
<html lang="en" class="light">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        ...
                        <ul class="{{Request::routeis('dashboard') ? 'side-menu__sub-open' : ''}}">
                            <li>
                   ...
                   @hasanyrole('admin')
                    <li>
                        ...
                        <ul class="{{Request::routeis('pd.brand')? 'side-menu__sub-open':''}} ">
                            <li>
 ...
 @hasanyrole('admin|product-manager')
                    ...
                    <li>
                        ...
                        <ul class="{{Request::routeis('product.add')? 'side-menu__sub-open':''}} ">
                            <li>
                ...
                <div class="top-bar">
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-pill overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-bs-toggle="dropdown">
                            <img alt="Rubick Tailwind HTML Admin Template" src="https://avatars.dicebear.com/api/initials/{{auth()->user()->name ? auth()->user()->name : 'mkarim'}}.svg">
                        </div>
                        <div class="dropdown-menu w-56">
                            <ul class="dropdown-content bg-theme-26 dark-bg-dark-6 text-white">
                                <li class="p-2">
                                    <div class="fw-medium text-white"> {{
                                        auth()->user()->name ? str()->headline(auth()->user()->name) : 'MK'}}</div>
                              ...
                              {{--   <li>
                                ...
                                <li>
                                    <a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover"> <i data-feather="toggle-right" class="w-4 h-4 me-2"></i> Logout </a>
